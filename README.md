...
magicpod-analyzer/0.3.1 darwin-x64 node-v16.13.0
...
_See code: [dist/commands/get-batch-runs.ts](https://github.com/takeya0x86/magicpod-analyzer/blob/v0.3.1/dist/commands/get-batch-runs.ts)_
